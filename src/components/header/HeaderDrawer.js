...
import UnauthorizedNotify from "../UnauthorizedNotify";
...
function HeaderDrawer(props){
    ...
    const handleOpenNotify = () => {
        if(!authStateContext.authReduced.state){
            setNotifyState(true)
        }
    }
    ...
    return (
        <>
            <UnauthorizedNotify open={notifyState} handleClose={() => setNotifyState(false)} />
            <Drawer
                ...
                <div className={classes.drawerContainer}>
                    ...
                    <List>
                        <ListItem button key="bookmarks"
                                  component={authStateContext.authReduced.state ? Link : false}
                                  to="/bookmarks"
